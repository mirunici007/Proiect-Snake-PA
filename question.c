...
void draw_question(QuestionNode* q)
{
    ...
    int y = 250;;
    //button width and height, spacing between buttons, and offset for answer text
    int boxWidth = 50;
    int boxHeight = 50;
    int spacing = 50;
    int answerSpacingY = 30;
    int answerTextOffsetX = 70;
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        Rectangle letterBox;
        letterBox.x = screenWidth / 2 - 400 + 10;
        ...
        //draw the letter (A, B, C, D) inside the button
        char letter[3] = { 'A' + i, '.', '\0' };
